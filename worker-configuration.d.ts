/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 242f464785d0a03511bc9a5a9fc6521f)
...
interface __BaseEnv_Env {
	...
	DEPLOY_D1_DATABASE_ID: string;
	DEPLOY_KV_NAMESPACE_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_SITE_TOKEN" | "DEPLOY_D1_DATABASE_ID" | "DEPLOY_KV_NAMESPACE_ID">> {}
}
